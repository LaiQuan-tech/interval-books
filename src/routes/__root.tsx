...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "小時光風土誌書店，座落於華山文創園區的城市心臟，卻選擇與時間保持一點距離。在這裡，書不只是被閱讀，它是一種與土地對話的媒介——氣味、聲音、記憶與日常，透過書頁、空間與人，悄悄流動。" },
      ...
      { property: "og:description", content: "小時光風土誌書店，座落於華山文創園區的城市心臟，卻選擇與時間保持一點距離。在這裡，書不只是被閱讀，它是一種與土地對話的媒介——氣味、聲音、記憶與日常，透過書頁、空間與人，悄悄流動。" },
      { name: "twitter:description", content: "小時光風土誌書店，座落於華山文創園區的城市心臟，卻選擇與時間保持一點距離。在這裡，書不只是被閱讀，它是一種與土地對話的媒介——氣味、聲音、記憶與日常，透過書頁、空間與人，悄悄流動。" },
